...
url: https://nextui.org/tools/theme/typescript
---
...
> For more information you can see the [Stitches theme documention](https://stitches.dev/tools/api#theme)
...
> See [Stitches type a CSS object](https://stitches.dev/tools/typescript#type-a-css-object) for more information.
...
> See [Stitches VariantProps](https://stitches.dev/tools/typescript#extract-variants-from-a-component) for more information.
