...
url: https://nextui.org/tools/theme/palette
---
...
in the [Default Theme](/tools/theme/default-theme) documentation.
...
> For more information about the theme tokens, see the [Stitches Custom theming](https://stitches.dev/tools/theming) documentation.
