...
url: https://nextui.org/tools/theme/dark-mode
---

# Dark mode

NextUI comes with two palette modes light (the default) and dark, as we mentioned [before](/tools/theme/customize-theme#theme-type).
...
> For further information about `createTheme`, please refer to the [typescript documentation](/tools/theme/typescript#create-theme).
...
> For more information on the default `colors`, `fonts`, `spaces`, etc.. please refer to the [default theme documentation](/tools/theme/default-theme).
