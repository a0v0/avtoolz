...
url: https://nextui.org/tools/theme/default-theme
---

# Default Theme

**NextUI** default theme is based on [Stitches Theme Tokens](https://stitches.dev/tools/tokens)
...
see the [theme object](/tools/guide/getting-started#theme-object) for more information.
...
By default these colors can be used by the `color`, `borderColor`, `backgroundColor`, `fill`, and so on, here is the complete list of properties where you can use the color tokens [Stitches Property Mapping](https://stitches.dev/tools/tokens#property-mapping).
...
> You can see the complete `space` list on [Stitches Property Mapping](https://stitches.dev/tools/tokens#property-mapping)
...
like [Container](/tools/layout/container) and [Grid](/tools/layout/grid).
