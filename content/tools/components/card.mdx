...
url: https://nextui.org/tools/components/card
---
...
- **Card.Image**: The image of the card, based on the NextUI [Image](/tools/components/image).
...
| -------------- | ------------------------------------------------- | ------------------------------------------------------------------------------ | ----------- | ------- |
| **ImageProps** | [ImageProps](/tools/components/image#image-props) | Since card image is based on the `Image` you can use any of the `Image` props. | -           |
