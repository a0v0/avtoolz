...
url: https://nextui.org/tools/components/switch
---

# Switch

The Switch component is used as an alternative for the [Checkbox](https://nextui.org/tools/components/checkbox)
