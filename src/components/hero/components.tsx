import { Logo, ThemeSwitch, UserTwitterCard } from "@components";
import { useIsMobile } from "@hooks/use-media-query";
import {
  Button, Card, Col, Grid, Input, Loading, Pagination, Row, styled, StyledButton, Text, Tooltip
  ...
  return (
    <StyledContainer>
      ...
      <Grid
        ...
        onClick={() => {
          router.push("/tools/guide/getting-started");
        }}
      >
        <Logo small size={60} />
      </Grid>
